...
Both the tablet view and the desktop view of what's graded and required is the same. Here is the mockup illustration of the desktop & tablet version of the site (only required graded parts shown):
 ...
 ![Desktop and Tablet](img/desktop.png)


Here is the mockup illustration of the mobile view (only required graded parts are shown):

 ![mobile collapsed](img/menu-collapsed.png)

 ![mobile expanded](img/mobile-expanded.png)
...
Here is the mockup illustration of the desktop version of the site: ![Desktop - optional](img/desktop-optional.png)

Here is the mockup illustration of the tablet version of the site:   

![Tablet - optional](img/tablet-optional.png)
...
![Mobile - Optional (Closed)](img/mobile-optional-collapsed.png)
![Mobile - Optional (Open)](img/mobile-optional-expanded.png)
